...
| **71** | **v42 Phase 6 94-NCT cut-over test** | **85154945fadf** | **94** | **—/94** | **Running** | **v42 (5f2d5d86)** | — | **First end-to-end prod run post-Phase-6. Same 94 NCTs as v41b shadow preview for direct comparison. First prod job with: (a) bioRxiv research agent, (b) prefer_atomic_classification=true, (c) prefer_atomic_failure_reason=true, (d) R4/R5 outcome rules removed. Expected shifts vs legacy: classification AMP recall 25%→75% (DBAASP Tier 0); outcome: -14 drug-level false positives, similar scoreable agreement with cleaner confidence distribution; failure_reason: +17pts business-reason coverage (web_context Tier 2). Small-job test a85a75247135 cancelled in favor of this full run.** |
