...
| **75** | **v42.6.5 50-NCT validation** | **068f3e183135** | **50** | **—/50** | **Running** | **v42.6.5 (6e932325)** | — | **First run with: (a) UPPERCASE intervention-type fix so pregate + AMP-skip actually fire, (b) bioRxiv per-intervention queries (no more "placebo" dominating fallback), (c) bioRxiv citations merged into outcome_atomic pub pipeline, (d) verifier_count knob available, (e) telemetry counters for pregate/amp_skip firings. Stratified batch: 10 R1=AMP + 40 R1=Other to measure AMP recall stability.** |
