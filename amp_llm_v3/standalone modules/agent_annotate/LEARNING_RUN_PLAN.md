...
| **76** | **v42.6.8 50-NCT validation** | **23443979931d** | **50** | **—/50** | **Running** | **v42.6.8 (472a58d9)** | — | **Same 50-NCT set as #75c for apples-to-apples. First run with bidirectional pregate: INN suffix classifier (-tide/-relin→True, -mab/-nib/-cept/etc→False) + strict non-peptide types + ChEMBL mol_type. DRUG with no affirmative signal now correctly defers to LLM. Target: AMP recall restored to ≥80%, classification ≥90%, some wall-time saving preserved via affirmative True-gates.** |
| **77** | **v42.6.8 100-NCT generalization** | **440f19adef5e** | **100** | **—/100** | **Queued** | **v42.6.8 (472a58d9)** | — | **Follow-up on unseen NCTs. Rich stratification: 15 AMPs + 40 non-AMP peptides + 45 others. Tests: (a) AMP recall on larger sample, (b) peptide accuracy on non-AMP hormones/GLP analogs, (c) pregate False-gate precision on mixed intervention types. Runs sequentially after Job #76.** |
