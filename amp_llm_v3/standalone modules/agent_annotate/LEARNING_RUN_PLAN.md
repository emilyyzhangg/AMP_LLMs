...
| **v27c** | **pending** | **self_audit AA range 2-50→2-100. memory_store learning patterns 2-50→2-100, multi-chain excludes peptide hormones. Verifier definition restored (no cheat-sheet examples). Consensus threshold stays 1.0.** |
