...
| **75c** | **v42.6.6 50-NCT clean validation** | **25dd30f19e7d** | **50** | **—/50** | **Running** | **v42.6.6 (e034d674)** | — | **Re-run of the original 50-NCT validation (10 AMPs + 40 Others) now that v42.6.6 fixed the port detection + autoupdater. First coherent measurement of: (a) pregate hit rate, (b) AMP-skip hit rate, (c) bioRxiv drug-relevance (per-intervention + placebo blacklist), (d) bioRxiv → Tier 1b pub merge effect on R8 rate.** |
