...
- **Commit:** `35b88e19` on dev (v42.7.7, dev-only). main is at `f574536f` (v42.7.6 merged 2026-04-27). v42.7.5 (code-sync diagnostic) + v42.7.6 (NIH RePORTER) shipped to prod and validated by smoke #91 + autoupdater pickup. v42.7.7 (vaccine-immunogenicity Positive override) on dev awaiting held-out validation.
