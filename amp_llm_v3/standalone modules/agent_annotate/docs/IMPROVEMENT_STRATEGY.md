...
> **Last updated:** 2026-05-08 — **v42.8 stack (Levers 1-5) LANDED on main**; full-corpus re-run (Jobs #105 `7e7efda9649e` + #106 `c7ca38f92f6b` queued) in flight to certify at scale; ETA 4-7 days. Slice-J Lever-5 breakout: 5/14 NCT05+ pos→unk flipped to Positive with 0 false positives. Projected v42.8 full-corpus: outcome ~45% (+2.7pp via Lever 5), RfF true-recall ~70% (+40pp via Lever 1's emission gate fixing the score-blindness gap). v42.9 plan drafted (`docs/V42_9_IMPLEMENTATION_PLAN.md`) targeting residual gaps: Lever 6 (conference abstracts), Lever 7 (SEC 8-K extension), Lever 8 (sequence-DB broadening). Job #104 stays deferred until #105+#106 land. Canonical sources for current state: AGENT_STRATEGY_ROADMAP, CONTINUATION_PLAN, LEARNING_RUN_PLAN, V42_8_IMPLEMENTATION_PLAN, V42_9_IMPLEMENTATION_PLAN, PRODUCTION_GATE_REPORT.
