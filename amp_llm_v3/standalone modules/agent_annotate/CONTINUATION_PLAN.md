...
| full-corpus-1 (re-run) | 315 | n/a | IN FLIGHT | Job #105 = `7e7efda9649e` (commit `916c1f1e`, submitted 2026-05-08). v42.8 stack certification at scale; ETA ~50-80h. |
| full-corpus-2 (re-run) | 315 | n/a | QUEUED    | Job #106 = `c7ca38f92f6b` (queued behind #105 2026-05-08, no --check-sync since #105 had pinned the service to an earlier commit). Will run sequentially after #105. |
