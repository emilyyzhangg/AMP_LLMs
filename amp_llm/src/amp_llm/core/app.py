...
from amp_llm.config.logging import get_logger, setup_logging, LogConfig
...
class Application:
    ...
    def __init__(self):
        ...
        # Setup logging - FIXED: Use correct attribute paths
        log_config = LogConfig(
            log_file=self.settings.output.log_file,     # ✅ output.log_file
            log_level=self.settings.output.log_level,   # ✅ output.log_level
        )
