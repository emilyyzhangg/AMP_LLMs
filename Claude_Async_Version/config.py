...
class APIConfig:
    ...
    timeout: int = 15
    max_retries: int = 3
    rate_limit_delay: float = 0.34  # NCBI requires max 3 requests/second
    max_concurrent: int = 5
    
    # User agent for API requests (required by NCBI)
    ...
    # Optional NCBI API key for higher rate limits (10 req/sec instead of 3)
...
class LLMConfig:
    ...
    idle_timeout: int = 3  # seconds of idle before considering response complete
